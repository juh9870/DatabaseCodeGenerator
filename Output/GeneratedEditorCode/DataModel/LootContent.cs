...
namespace EditorDatabase.DataModel
{
	...
	public partial class LootContent_Fuel : ILootContentContent
	{
		...
		public void Load(LootContentSerializable serializable, Database database)
		{
			MinAmount = new NumericValue<int>(serializable.MinAmount, 0, 2147483647);
			MaxAmount = new NumericValue<int>(serializable.MaxAmount, 0, 2147483647);
		...
		public NumericValue<int> MinAmount = new NumericValue<int>(0, 0, 2147483647);
		public NumericValue<int> MaxAmount = new NumericValue<int>(0, 0, 2147483647);
	}
