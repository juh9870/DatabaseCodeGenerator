...
namespace EditorDatabase.DataModel
{
	public partial class BulletBody
	{
		...
		public BulletBody(BulletBodySerializable serializable, Database database)
		{
			...
			Range = new NumericValue<float>(serializable.Range, 0f, 3.402823E+38f);
			Lifetime = new NumericValue<float>(serializable.Lifetime, 0f, 3.402823E+38f);
			Weight = new NumericValue<float>(serializable.Weight, 0f, 3.402823E+38f);
			HitPoints = new NumericValue<int>(serializable.HitPoints, 0, 2147483647);
			Color = Helpers.ColorFromString(serializable.Color);
			BulletPrefab = database.GetBulletPrefabId(serializable.BulletPrefab);
			EnergyCost = new NumericValue<float>(serializable.EnergyCost, 0f, 3.402823E+38f);
		...
		public NumericValue<float> Weight = new NumericValue<float>(0, 0f, 3.402823E+38f);
		public NumericValue<int> HitPoints = new NumericValue<int>(0, 0, 2147483647);
		public System.Drawing.Color Color;
		public ItemId<BulletPrefab> BulletPrefab = ItemId<BulletPrefab>.Empty;
		public NumericValue<float> EnergyCost = new NumericValue<float>(0, 0f, 3.402823E+38f);
